...
engine=pyyttsx3.init()
engine.setProperty("rate",150)
voices=engine.getProperty('voices')
enine.setProperty('voice',voices[1].id)
...
def run_alexa():
    ...
    try:
        ...
        if 'alexa' in command:
            ...
            print('you said: '+command)
        if 'hello' in command:
            print('hello how can i helpp u..')
            engine_talk('hello, how can i helpp ..')
        elif 'who are u' in command:
            print('I am mini alexa a k a your virtual assistant master')
            engine_talk('I am mini alexa a k a your virtual assistant master.how can I help u??')

        elif 'can u do' in command:
            print('''i can play songs on utube,tell you a joke,search on wikipedia,tell date and time,find ur location,locate area on map,open different websites like instagram,utube,gmail,github,stack overflow and searches on google.How may i help u?''')
            engine_talk('''i can play songs on utube,tell you a joke,search on wikipedia,tell date and time,find ur location,locate area on map,open different websites like instagram,utube,gmail,github,stack overflow and searches on google.How may i help u?''')
        ...
        print(ex)
print('clearing background noise...plzz wait')
engine_talk('clearing background noise...plzz wait')
print('\n')
print('hello i am mini alexa how can i help u??')
engine_talk('hello i am mini alexa how can i help u??')
